...
def opencsv():
    # 使用 pandas 打开
    data = pd.read_csv('data/4-Kaggle/digit-recognizer/input/train.csv')
    data1 = pd.read_csv('data/4-Kaggle/digit-recognizer/input/test.csv')
...
def dRecognition_knn():
    ...
    # 结果的输出
    saveResult(testLabel, 'data/4-Kaggle/digit-recognizer/ouput/Result_sklearn_knn.csv')
    print "finish!"
